...
// NOTA: este módulo restaura SOLO el espejo del DOM (rrweb) del personal.
// La cámara y el control remoto quedaron RETIRADOS a propósito: esto es
// visualización de la ventana, no acceso al aparato.
...
export function iniciarSupervision(user: User): void {
  ...
  // sin esperar a negociar nada. Solo el espejo del DOM: sin cámara.
