...
export default function AdminPanel({ 
  ...
  const handleSaveConfig = () => {
    ...
    if (storeLogoPreview) { import('../utils/storage').then(mod => mod.saveLogo(storeLogoPreview)); } db.settings.storeLogo = undefined;
...
const handleToggleEmployeeState = (empId: string, name: string, currentState: boolean) => {
  ...
  // Credit Note returns
  const handleIssueCreditNote = (orderId: string) => {
