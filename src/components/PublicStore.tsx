...
export default function PublicStore({ 
  ...
  const handleConfirmOrder = async (e: React.FormEvent) => {
    ...
    // Log inventory movements (stock was already deducted atomically in Firestore by processSaleAtomic)
    cart.forEach(it => {
      const freshDb = getDB();
      freshDb.inventory_movements.unshift({
    ...
    // Save only clients, deliveries, and orders — NOT products (stock was already updated atomically in Firestore by processSaleAtomic).
